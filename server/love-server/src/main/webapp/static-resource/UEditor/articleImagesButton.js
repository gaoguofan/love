           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					jQuery.ajax({
               			        ...
               			        success: function(data) {
               			            if(data.code == 0){
               			            	UE.getEditor('editor1').execCommand('insertHtml', '<img style="margin-top: 0px; width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+data.msg+'">');
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					jQuery.ajax({
               			        ...
               			        success: function(data) {
               			            if(data.code == 0){
               			            	UE.getEditor('editor2').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+data.msg+'">');
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					jQuery.ajax({
               			        ...
               			        success: function(data) {
               			            if(data.code == 0){
               			            	UE.getEditor('editor3').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+data.msg+'">');
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					jQuery.ajax({
               			        ...
               			        success: function(data) {
               			            if(data.code == 0){
               			            	UE.getEditor('editor4').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+data.msg+'">');
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					jQuery.ajax({
               			        ...
               			        success: function(data) {
               			            if(data.code == 0){
               			            	UE.getEditor('editor5').execCommand('insertHtml', '<img  style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+data.msg+'">');
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					jQuery.ajax({
               			        ...
               			        success: function(data) {
               			            if(data.code == 0){
               			            	UE.getEditor('editor6').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+data.msg+'">');
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					jQuery.ajax({
               			        ...
               			        success: function(data) {
               			            if(data.code == 0){
               			            	UE.getEditor('editor7').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+data.msg+'">');
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					jQuery.ajax({
               			        ...
               			        success: function(data) {
               			            if(data.code == 0){
               			            	UE.getEditor('editor8').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+data.msg+'">');
