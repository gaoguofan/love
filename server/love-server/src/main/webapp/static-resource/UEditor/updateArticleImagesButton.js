           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor1').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+sourceLink+'">');
           	    ...
           	    qiniu2.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor2').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+sourceLink+'">');
           	    ...
           	    qiniu3.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor3').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+sourceLink+'">');
           	    ...
           	    qiniu4.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor4').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+sourceLink+'">');
           	    ...
           	    qiniu5.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor5').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+sourceLink+'">');
           	    ...
           	    qiniu6.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor6').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+sourceLink+'">');
           	    ...
           	    qiniu7.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor7').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+sourceLink+'">');
           	    ...
           	    qiniu8.uploader({
           			...
           			init : {
           				...
           				'FileUploaded' : function(up, file, info) {
           					...
           					var res = eval('(' + info + ')');
           					var sourceLink = domain + res.key;
           						UE.getEditor('editor8').execCommand('insertHtml', '<img style=" width: 100%; padding: 0px; border-color: rgb(30, 155, 232); color: inherit; height: 100%;" data-width="100%" border="0" vspace="0" src="'+sourceLink+'">');
