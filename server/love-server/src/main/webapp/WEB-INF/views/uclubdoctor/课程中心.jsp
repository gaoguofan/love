...
<!--     	<header class="H-header H-theme-background-color2" id="header">
	...
	<div style="width:100%;height:40px;text-align:center;line-height:40px;background:#fff;">
		<a href="javascript:void(0)" style="color:#000;text-decoration:none;">点会员中心-在线升级-解锁更多案例-找到女朋友</a>
	</div>
	<div class="H-flexbox-horizontal H-theme-background-color-white H-border-vertical-top-after" style="padding-top:10px;">
        <div class="H-flex-item H-center-all H-text-align-center H-touch-active H-theme-font-color-red" onclick="window.location.href='<%=basePath%>app/mvp'">
            <div>
        ...
        <div class="H-flex-item H-center-all H-text-align-center H-touch-active H-theme-font-color-red" onclick="window.location.href='<%=basePath%>app/class'">
            <div>
        ...
        <div class="H-flex-item H-center-all H-text-align-center H-touch-active H-theme-font-color-red" onclick="dialog('请联系导师')">
            <div>
...
<!-- 	<div style="padding-left:3%;background:#fff;">
	...
	<div class="H-padding-vertical-bottom-10" style="border-bottom:1px solid #ddd;background:#fff;"></div>
		<c:forEach items="${loveArticleInfos }" var="loveArticleInfo">
			<div onclick="show_tx(${loveArticleInfo.id})" class="H-flexbox-horizontal H-theme-background-color-white H-border-vertical-bottom-after" id="lttwList" style="display: block;">
		        <div class="H-padding-vertical-both-10" style="width: 25%;float: left;"><a href="javascript:void(0)" style="text-decoration:none;"><img src="${loveArticleInfo.shutImagePath }" class="H-display-block H-margin-horizontal-left-10" style="width: 70px; height: 70px;"/></a></div>
		        <div class="H-flex-item H-padding-10">
		            ...
		            <div class="H-font-size-14 H-theme-font-color-999 H-text-show-row-2 H-margin-vertical-top-2"><a href="javascript:void(0)" style="color:#999;text-decoration:none;">${loveArticleInfo.shutText }</a></div>
		        </div>
		    </div>
	    </c:forEach>
    </div>
...
<script>
function show_tx(id) {
	window.location.href = baseUrl + "app/class/info?id=" + id;
	dialog(id)
}
