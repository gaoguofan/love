...
public class AddressUtils {
     ...
     */
    public static net.sf.json.JSONObject getAddresses(String content, String encodingString) {
        // 这里调用淘宝API
        ...
        if (returnStr != null) {
            ...
            return net.sf.json.JSONObject.fromObject(returnStr);
        }
        return null;
    }
    /**
    ...
    public static void main(String[] args) {
        ...
        String ip = "113.87.212.150";
        net.sf.json.JSONObject address = null;
